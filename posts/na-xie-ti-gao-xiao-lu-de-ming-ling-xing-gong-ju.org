...
* bat
  ...
  :END:
  bat? No，高端cat，不费眼。[[https://github.com/sharkdp/bat][地址]]
* wifi-password
  :PROPERTIES:
  :ID:       892F4876-D417-43AB-8118-5940DB103515
  :END:
  在命令行中显示当前连接wifi的密码，只支持mac。[[https://github.com/rauchg/wifi-password][地址]]
* cowsay
  :PROPERTIES:
...
* direnv
  ...
  :END:
  环境变量切换，可以指定在进入某一文件夹后的操作，比如输出一条欢迎语句，在退出文件夹后则卸载变量。 [[https://github.com/direnv/direnv][地址]]
* exa
  :PROPERTIES:
  :ID:       B96E9C09-3FA8-4C54-9140-591F5004BFF8
  :END:
  ls、tree的替代者，支持多种显示方式。[[https://github.com/ogham/exa][地址]]
* duti
  :PROPERTIES:
...
* riggrep
  ...
  :END:
  强大的find，查询速度更快。[[https://github.com/BurntSushi/ripgrep][地址]]
* fortune
  :PROPERTIES:
...
* fzf
  ...
  :END:
  强大的交互式搜索，大大提高效率。[[https://github.com/junegunn/fzf][地址]]
* goku
  :PROPERTIES:
